...
const char *radxa_rock_5b_serialdev[MRAA_RADXA_ROCK_5B_UART_COUNT] = {
    "/dev/ttyS2", "/dev/ttyS3", "/dev/ttyS4", "/dev/ttyS7"};

void
mraa_radxa_rock_5b_pininfo(mraa_board_t *board, int index, int gpio_chip, int gpio_line,
...
mraa_radxa_rock_5b()
{
    ...
    mraa_radxa_rock_5b_pininfo(b, 3, 4, 11, (mraa_pincapabilities_t) {1, 1, 1, 0, 0, 0, 0, 0},
                               "GPIO4_B3"); // i2c7 channel is occupied by i2c7-m0 in kernel
    mraa_radxa_rock_5b_pininfo(b, 4, -1, -1, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 0}, "5V");
    mraa_radxa_rock_5b_pininfo(b, 5, 4, 10, (mraa_pincapabilities_t) {1, 1, 1, 0, 0, 0, 0, 0},
                               "GPIO4_B2"); // i2c7 channel is occupied by i2c7-m0 in kernel
    ...
    mraa_radxa_rock_5b_pininfo(b, 8, 4, 13, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 1, 0, 1},
                               "GPIO0_B5"); // GPIO0_B5 was used by fiq_debugger, function GPIO cannot be enabled
    mraa_radxa_rock_5b_pininfo(b, 9, -1, -1, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 0}, "GND");
    mraa_radxa_rock_5b_pininfo(b, 10, 0, 14, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 1, 0, 1},
                               "GPIO0_B6"); // GPIO0_B6 was used by fiq_debugger, function GPIO cannot be enabled
