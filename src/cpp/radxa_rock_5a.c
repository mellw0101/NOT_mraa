...
const char *radxa_rock_5a_serialdev[MRAA_RADXA_ROCK_5A_UART_COUNT] = {
    "/dev/ttyS2", "/dev/ttyS4", "/dev/ttyS6", "/dev/ttyS7", "/dev/ttyS8"};

void
mraa_radxa_rock_5a_pininfo(mraa_board_t *board, int index, int gpio_chip, int gpio_line,
...
mraa_radxa_rock_5a()
{
    ...
    mraa_radxa_rock_5a_pininfo(
        b, 8, 0, 13, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 1, 0, 1}, "GPIO0_B5");  // Used by fiq_debugger
    mraa_radxa_rock_5a_pininfo(b, 9, -1, -1, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 0}, "GND");
    mraa_radxa_rock_5a_pininfo(
        b, 10, 0, 14, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 1, 0, 1}, "GPIO0_B6"); // Used by fiq_debugger
    mraa_radxa_rock_5a_pininfo(b, 11, 4, 11, (mraa_pincapabilities_t) {1, 1, 1, 0, 0, 0, 0, 0},
                               "GPIO4_B3"); // I2C-M0 is used by on-board devices
    mraa_radxa_rock_5a_pininfo(b, 12, 4, 1, (mraa_pincapabilities_t) {1, 1, 0, 0, 1, 0, 0, 0}, "GPIO4_A1");
    mraa_radxa_rock_5a_pininfo(b, 13, 4, 10, (mraa_pincapabilities_t) {1, 1, 1, 0, 1, 0, 0, 0},
                               "GPIO4_B2"); // I2C-M0 is used by on-board devices
