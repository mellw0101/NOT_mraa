...
const char *radxa_rock_3c_serialdev[MRAA_RADXA_ROCK_3C_UART_COUNT] = {
    "/dev/ttyS2", "/dev/ttyS3", "/dev/ttyS4", "/dev/ttyS5", "/dev/ttyS9"};

void
mraa_radxa_rock_3c_pininfo(mraa_board_t *board, int index, int gpio_chip, int gpio_line,
...
mraa_radxa_rock_3c()
{
    ...
    mraa_radxa_rock_3c_pininfo(
        b, 3, 1, 0, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 1, 0, 1}, "GPIO0_D1"); // Hardware pull-up on this pin
    mraa_radxa_rock_3c_pininfo(b, 4, -1, -1, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 0}, "5V");
    mraa_radxa_rock_3c_pininfo(
        b, 5, 1, 1, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 1, 0, 1}, "GPIO0_D0"); // Hardware pull-up on this pin
    ...
    mraa_radxa_rock_3c_pininfo(
        b, 8, 0, 25, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 1}, "GPIO0_D1");  // Used by fiq_debugger
    mraa_radxa_rock_3c_pininfo(b, 9, -1, -1, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 0}, "GND");
    mraa_radxa_rock_3c_pininfo(
        b, 10, 0, 24, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 1}, "GPIO0_D0"); // Used by fiq_debugger
    ...
    mraa_radxa_rock_3c_pininfo(
        b, 37, 1, 4, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 0}, "GPIO1_A4"); // can not set gpio pinmux
