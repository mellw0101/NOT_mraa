...
void
mraa_radxa_cm3_pininfo(mraa_board_t *board, int index, int gpio_chip, int gpio_line,
...
mraa_radxa_cm3()
{
    ...
    mraa_radxa_cm3_pininfo(b, 8, 0, 25, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 1},
    ...
    mraa_radxa_cm3_pininfo(b, 10, 0, 24, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 1},
