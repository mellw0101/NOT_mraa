...
const char *radxa_rock_3b_serialdev[MRAA_RADXA_ROCK_3B_UART_COUNT] = {
    "/dev/ttyS0", "/dev/ttyS2", "/dev/ttyS3", "/dev/ttyS5", "/dev/ttyS7", "/dev/ttyS9"};

void
mraa_radxa_rock_3b_pininfo(mraa_board_t *board, int index, int gpio_chip, int gpio_line,
                           mraa_pincapabilities_t pincapabilities_t, char *pin_name)
{
...
mraa_radxa_rock_3b()
{
    ...
    mraa_radxa_rock_3b_pininfo(b, 3, 1, 0, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 1, 0, 1},
                               "GPIO1_A0"); // GPIO1_A0 was used by audiopwm, function GPIO cannot be enabled
    mraa_radxa_rock_3b_pininfo(b, 4, -1, -1, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 0}, "5V");
    mraa_radxa_rock_3b_pininfo(b, 5, 1, 1, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 1, 0, 1},
                               "GPIO1_A1"); // GPIO1_A1 was used by audiopwm, function GPIO cannot be enabled
    mraa_radxa_rock_3b_pininfo(b, 6, -1, -1, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 0}, "GND");
    mraa_radxa_rock_3b_pininfo(b, 7, 0, 13, (mraa_pincapabilities_t) {1, 0, 1, 0, 0, 1, 0, 0},
                               "GPIO0_B5"); // hardware pull up, function GPIO cannot be enabled
    mraa_radxa_rock_3b_pininfo(b, 8, 0, 25, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 1},
                               "GPIO0_D1"); // GPIO0_D1 was used by fiq_debugger, function GPIO cannot be enabled
    mraa_radxa_rock_3b_pininfo(b, 9, -1, -1, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 0}, "GND");
    mraa_radxa_rock_3b_pininfo(b, 10, 0, 24, (mraa_pincapabilities_t) {1, 0, 0, 0, 0, 0, 0, 1},
                               "GPIO0_D0"); // GPIO0_D0 was used by fiq_debugger, function GPIO cannot be enabled
    ...
    mraa_radxa_rock_3b_pininfo(b, 16, 0, 14, (mraa_pincapabilities_t) {1, 0, 1, 0, 0, 1, 0, 0},
                               "GPIO0_B6"); // Hardware pull up, function GPIO cannot be enabled
