...
mraa_iei_tank()
{
    ...
    b->uart_dev_count = 6;
    b->def_uart_dev   = 0;
    if (mraa_find_uart_bus_pci("/sys/devices/pnp0/00:03/tty", &(b->uart_dev[0].device_path)) != MRAA_SUCCESS)
    {
    ...
    if (mraa_find_uart_bus_pci("/sys/devices/pnp0/00:04/tty", &(b->uart_dev[1].device_path)) != MRAA_SUCCESS)
    {
    ...
    if (mraa_find_uart_bus_pci("/sys/devices/pnp0/00:05/tty", &(b->uart_dev[2].device_path)) != MRAA_SUCCESS)
    {
    ...
    if (mraa_find_uart_bus_pci("/sys/devices/pnp0/00:06/tty", &(b->uart_dev[3].device_path)) != MRAA_SUCCESS)
    {
    ...
    if (mraa_find_uart_bus_pci("/sys/devices/pnp0/00:07/tty", &(b->uart_dev[4].device_path)) != MRAA_SUCCESS)
    {
    ...
    if (mraa_find_uart_bus_pci("/sys/devices/pnp0/00:08/tty", &(b->uart_dev[5].device_path)) != MRAA_SUCCESS)
    {
